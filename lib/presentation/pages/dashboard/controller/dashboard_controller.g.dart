...
mixin _$DashboardController on _DashboardController, Store {
  ...
  String get currentPageName =>
      (_$currentPageNameComputed ??= Computed<String>(
  ...
  @override
  bool get isHomePage =>
      (_$isHomePageComputed ??= Computed<bool>(
            () => super.isHomePage,
  ...
  bool get isFriendsPage =>
      (_$isFriendsPageComputed ??= Computed<bool>(
            () => super.isFriendsPage,
  ...
  @override
  bool get isFriendActionsPage =>
      (_$isFriendActionsPageComputed ??= Computed<bool>(
            () => super.isFriendActionsPage,
  ...
  @override
  bool get isSuggestionsPage =>
      (_$isSuggestionsPageComputed ??= Computed<bool>(
  ...
  int get unreadNotificationsCount =>
      (_$unreadNotificationsCountComputed ??= Computed<int>(
            () => super.unreadNotificationsCount,
  ...
  late final _$currentPageIndexAtom = Atom(
    name: '_DashboardController.currentPageIndex',
    context: context,
  );
  ...
  late final _$isDrawerOpenAtom = Atom(
    name: '_DashboardController.isDrawerOpen',
    context: context,
  );
  ...
  late final _$notificationsAtom = Atom(
    name: '_DashboardController.notifications',
    context: context,
  );
  ...
  late final _$hasUnreadNotificationsAtom = Atom(
    name: '_DashboardController.hasUnreadNotifications',
    context: context,
  );
  ...
  set hasUnreadNotifications(bool value) {
    _$hasUnreadNotificationsAtom.reportWrite(
      value,
  ...
  late final _$errorMessageAtom = Atom(
    name: '_DashboardController.errorMessage',
    context: context,
  );
  ...
  late final _$loadNotificationsAsyncAction = AsyncAction(
    '_DashboardController.loadNotifications',
    context: context,
  );
  ...
  Future<bool> markNotificationAsRead(int notificationId) {
    return _$markNotificationAsReadAsyncAction.run(
      () => super.markNotificationAsRead(notificationId),
    );
  }
  ...
  Future<bool> markAllNotificationsAsRead() {
    return _$markAllNotificationsAsReadAsyncAction.run(
      () => super.markAllNotificationsAsRead(),
    );
  }

  late final _$deleteNotificationAsyncAction = AsyncAction(
    '_DashboardController.deleteNotification',
    context: context,
  );
  ...
  late final _$_DashboardControllerActionController = ActionController(
