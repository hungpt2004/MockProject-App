...
class CardFriendDashboardWidget extends StatefulWidget {
  ...
  @override
  State<CardFriendDashboardWidget> createState() => _CardFriendDashboardWidgetState();
}
      ...
      children: [
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: MyImageWidget(
              imageUrl: widget.user.coverImageUrl ?? 'https://via.placeholder.com/300x140',
            ),
          ),
        ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: AdvancedAvatar(
              size: 50,
              image: NetworkImage(widget.user.avatarUrl ?? 'https://via.placeholder.com/100'),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${widget.user.numberFriends ?? 0} mutual friends',
                  style: TextStyle(
