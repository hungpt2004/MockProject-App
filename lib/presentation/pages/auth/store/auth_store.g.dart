...
mixin _$AuthStore on _AuthStore, Store {
  ...
  late final _$isLoadingProvinceAtom = Atom(
    name: '_AuthStore.isLoadingProvince',
    context: context,
  );
  ...
  late final _$loadVietNamProvincesAsyncAction = AsyncAction(
    '_AuthStore.loadVietNamProvinces',
    context: context,
  );
